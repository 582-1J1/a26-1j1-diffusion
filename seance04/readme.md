...
- Reconnaître les valeurs booléennes `true` et `false`
- Comparer deux valeurs avec les opérateurs de comparaison
- Utiliser `alert()`, `prompt()` et `typeof` pour interagir et déboguer
